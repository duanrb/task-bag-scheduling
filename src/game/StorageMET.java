...
public class StorageMET extends GenericStorage {

	public StorageMET(int iClass, int iSite) {
		super(iClass, iSite);
	...
	void findMinAct() {
		...
		for (int i = 0; i < iClass; i++) {
			...
			if (iaQueuedTask[iMinClass] > 0
				&& getAvailableStorage(iMinSite, dmMinminTime[iMinClass][iMinSite]) >= daStorageInput[iMinClass]+ daStorageOutput[iMinClass]) {
	...
	public static void main(String[] args) {
		MET workflowOptimization = new MET(2, 2);
